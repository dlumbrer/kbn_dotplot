    ...
    if (resp) {
      ...
      if (resp.aggs.bySchemaName('x-axis')) {
        ...
        if (metricsAgg_xAxis.params.customLabel) {
          ...
          var metricsAgg_xAxis_title = resp.aggs.bySchemaName('x-axis')[0].type.title + " " + metricsAgg_xAxis_name
        }
      }
      if (resp.aggs.bySchemaName('y-axis')) {
        ...
        if (metricsAgg_yAxis.params.customLabel) {
          ...
          var metricsAgg_yAxis_title = resp.aggs.bySchemaName('y-axis')[0].type.title + " " + metricsAgg_yAxis_name
        }
      }
