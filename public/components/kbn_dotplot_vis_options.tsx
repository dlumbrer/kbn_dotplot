...
export interface KbnDotplotVisParams {
  type: 'dotplot';
}

function KbnDotplotOptions({
  stateParams,
  setValue,
}: VisOptionsProps<KbnDotplotVisParams>) {

  return (
    <div className="kbn-dotplot-vis-params">
...
export { KbnDotplotOptions as default };
